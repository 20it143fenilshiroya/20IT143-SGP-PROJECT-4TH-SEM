            ...
            <div class="container-fluid p-0">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="doctors.php?page=doctors&sid=<?php echo $row['id'] ?>">
...
div#menu-field .menu-item {
    cursor: pointer
}
div#menu-field img, div#menu-field .menu-item-details {
    margin:auto;
    max-height: 70vh;
...
.modal-dialog.modal-full-height.modal-md .modal-content{
  height: 100vh;
}
...
.modal-full-height.modal-md .modal-body {
    position: relative;
    flex: 1 1 auto;
    padding: 1rem;
    overflow: auto;
...
.badge-light {
    ...
    <script>
       ...
       $('.view_schedule').click(function(){
			uni_modal($(this).attr('data-name')+" - Schedule","C:\xampp\htdocs\mediserve\admin\view_doctor_schedule.php?id="+$(this).attr('data-id'))
		})
       $('.set_appointment').click(function(){
       	if('<?php echo isset($_SESSION['login_id']) ?>' == 1)
			uni_modal("Set Appointment with "+$(this).attr('data-name'),"C:\xampp\htdocs\mediserve\admin\set_appointment.php.php?id="+$(this).attr('data-id'),'mid-large')
		else{
			uni_modal("Login First","index.php")
		}
		})
    </script>
